...
To continue this work would require procuring a newer, regularly updated dataset of job postings, taking into account the aforementioned caveats and limitations. From a data analyst perspective, perhaps I should heed my own findings and learn python for the purposes of scraping and extracting such data myself.  


#### I would like to express my gratitutde to Luke Barousse and Kelly Adams for putting together the SQL course from which this porject was produced, for providing the dataset publicly, and diligently putting into practice the cornerstones of good instructional design for the benefit of others. I look forward to more courses under your shared guidance.
